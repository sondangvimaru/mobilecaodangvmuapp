    ...
    <style>
        *{
        ...
        .table-wrapper{
            ...
            box-shadow: 0px 35px 50px rgba(74, 157, 195, 0.6);
        }
...
<h2><?php echo "Bảng điểm ". $arr[0]["msv"]."-".$arr[0]["ten"]?></h2>
<h2><input style="text-align: center" type="button" class="btn btn-success" value="Dowload Bảng Điểm" onclick="dowloaddiem()"></h2>
<script>
    function dowloaddiem() {

        window.location="http://localhost:8000/caodangvmu/ConnectClient/dowloaddiem.php";
    }
</script>
<div class="table-wrapper">
    <table class="fl-table">
        ...
        foreach ($arr as $diem)
        {
            ...
            <tr>
                <td><?php echo $diem["tenhocphan"];?></td>
                <td><?php echo $diem["diemX"];?></td>
                <td><?php echo $diem["diemY"];?></td>
                <td><?php echo $diem["diemZ"];?></td>
                <td><?php echo $diem["diemchu"];?></td>
                <td><?php echo $diem["diemso"];?></td>
                <td><?php echo $diem["ghichu"];?></td>
